...
namespace details {
[[nodiscard]] static constexpr uint16_t flip16(uint16_t u16) {
...
[[nodiscard]] static constexpr uint32_t flip32(uint32_t u32) {
...
[[nodiscard]] static constexpr uint64_t flip64(uint64_t u64) {
